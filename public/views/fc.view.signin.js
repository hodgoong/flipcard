function view_signin() {
    ...
    <div>
        ...
        <div class="card" style="width: 22rem; height: 12rem; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.5)">
            <div class="card-body">
                <div class="mb-3">
                    <input id="input-id" type="text" class="form-control" placeholder="ID">
                </div>
                <div class="mb-3">
                    <input id="input-pw" type="password" class="form-control" placeholder="PASSWORD">
                </div>
                <div>
                    <button class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent" onClick="auth.signin('normal')">
                        Sign In
                    </button>
                    <button class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent" onClick="auth.signup()">
                        Sign Up
                    </button>
                    <button class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect         mdl-button--accent" onClick="auth.signin('guest')">
                    Guest
                </button>
                </div>
            </div>
